...
da diese auch für Kriminelle zwecke Missbrauch werden können und somit auch unterschiedliche Gegenmaßnahmen auf verschiedenen ebenen also auf technischer, gesellschaftlicher als auch rechtlicher Ebene abgesichert werden müssen.\cite{CounterExtremism2020}

\subsection{Technologische Lösungen}
Durch die Unterschiedlichen Varianten der Deepfake Technologien werden unterschiedliche arten von Technologien verwendet, um gegen diese vorzugehen.
\subsubsection{KI-Erkennungsmechanismen}
Durch das voran schreiten der KI-Modelle werden Convolutional Neural Networks kurzgenannt CNNs darauf Trainiert, um Anomalien in Gesichtbewegung oder Sprachmodulation zu erkennnen, die auf Fälschungen hinweisen könnten.
